'use strict';
//
// Programmatic / embedded SDK entry for @thomsen/codegraph (issue #354).
//
...
var pkg = '@thomsen/codegraph-' + target;
...
function resolveLibrary() {
  ...
  throw new Error(
    ...
    '      npm i @thomsen/codegraph --registry=https://registry.npmjs.org\n' +
    '  - or run the CLI once (e.g. `npx @thomsen/codegraph status`) to\n' +
