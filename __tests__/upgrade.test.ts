...
describe('detectInstallMethod', () => {
  ...
  it('detects a global npm install', () => {
    const filename = '/usr/local/lib/node_modules/@thomsen/codegraph/dist/bin/codegraph.js';
    const m = detectInstallMethod({
      filename,
      platform: 'linux',
      cwd: '/home/u/project',
  ...
  it('detects a local (project) npm install as local', () => {
    ...
    const filename = `${cwd}/node_modules/@thomsen/codegraph/dist/bin/codegraph.js`;
  ...
  it('detects an npx run from the _npx cache', () => {
    const filename = '/home/u/.npm/_npx/abc123/node_modules/@thomsen/codegraph/dist/bin/codegraph.js';
  ...
  it('detects the npm thin-installer platform package as npm, not bundle', () => {
    const root = '/usr/local/lib/node_modules/@thomsen/codegraph/node_modules/@thomsen/codegraph-linux-x64';
    const filename = `${root}/lib/dist/bin/codegraph.js`;
  ...
  it('detects a project-local thin-installer platform package as npm local', () => {
    const cwd = '/home/u/project';
    const root = `${cwd}/node_modules/@thomsen/codegraph/node_modules/@thomsen/codegraph-darwin-arm64`;
    const filename = `${root}/lib/dist/bin/codegraph.js`;
    const present = new Set([`${root}/node`, `${root}/bin/codegraph`]);
  ...
  it('still detects an npx run when the cached platform package has the bundle layout', () => {
    const root = '/home/u/.npm/_npx/abc123/node_modules/@thomsen/codegraph/node_modules/@thomsen/codegraph-linux-x64';
    const filename = `${root}/lib/dist/bin/codegraph.js`;
    const present = new Set([`${root}/node`, `${root}/bin/codegraph`]);
