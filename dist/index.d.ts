...
export declare class CodeGraph {
    ...
    static initWorkspace(root: string): Promise<CodeGraph>;
    /**
    ...
    indexSourceRoot(sourceRoot: string, pathPrefix: string, options?: IndexOptions): Promise<IndexResult>;
    /** Sync one physical source root while preserving its logical workspace prefix. */
    syncSourceRoot(sourceRoot: string, pathPrefix: string, options?: IndexOptions): Promise<SyncResult>;
    /** Incrementally reconcile every member of the loaded workspace manifest. */
    syncWorkspace(options?: IndexOptions): Promise<SyncResult>;
    /**
     ...
     */
    replaceWorkspaceMember(memberName: string, nextPath: string): Promise<void>;
    /**
