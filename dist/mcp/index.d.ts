 ...
 */
export declare function timestampStderrLines(): void;
/** Prepend `[<ISO-8601>] ` to a log chunk; unknown chunk types pass through. */
export declare function stampLogChunk(chunk: string | Uint8Array): string | Uint8Array;
/**
 ...
 */
export declare function watchdogProgressPaths(root: string | null): {
