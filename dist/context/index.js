...
class ContextBuilder {
    ...
    queries;
    traverser;
    constructor(projectRoot, queries, traverser, resolveFilePath) {
    ...
    async extractNodeCode(node) {
        ...
        const filePath = this.resolveFilePath
            ...
            : (0, utils_1.validatePathWithinRoot)(this.projectRoot, node.filePath);
 ...
 */
function createContextBuilder(projectRoot, queries, traverser, resolveFilePath) {
