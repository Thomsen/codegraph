...
export declare class ContextBuilder {
    ...
    private queries;
    private traverser;
    constructor(projectRoot: string, queries: QueryBuilder, traverser: GraphTraverser, resolveFilePath?: ((filePath: string) => string | null) | undefined);
    /**
 ...
 */
export declare function createContextBuilder(projectRoot: string, queries: QueryBuilder, traverser: GraphTraverser, resolveFilePath?: (filePath: string) => string | null): ContextBuilder;
