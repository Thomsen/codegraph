...
const copilot_vscode_1 = require("./copilot-vscode");
const copilot_cli_1 = require("./copilot-cli");
const copilot_jetbrains_1 = require("./copilot-jetbrains");
exports.ALL_TARGETS = Object.freeze([
    ...
    kiro_1.kiroTarget,
    copilot_vscode_1.copilotVscodeTarget,
    copilot_cli_1.copilotCliTarget,
    copilot_jetbrains_1.copilotJetbrainsTarget,
]);
