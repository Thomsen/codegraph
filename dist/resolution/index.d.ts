...
import { UnresolvedRef, ResolvedRef, ResolutionResult, ResolutionContext } from './types';
...
export declare class ReferenceResolver {
    ...
    private methodOwnerIndexCache;
    private supertypeGen;
    private supertypeMemo;
    /** Invalidate the getSupertypes memo — call when resolved edges may have advanced. */
    private advanceSupertypeGeneration;
     ...
     */
    private static partitionResolvedCleanup;
    /**
     ...
     */
    private static partitionFailedCleanup;
    /**
     ...
     */
    resolveAndPersistBatched(onProgress?: (current: number, total: number) => void, batchSize?: number, onSynthesisProgress?: (done: number, total: number) => void, parallel?: {
        dbPath: string;
        bulkEdgeLoad?: {
            begin: () => void;
...
export declare function createResolver(projectRoot: string, queries: QueryBuilder, options?: ReferenceResolverOptions): ReferenceResolver;
