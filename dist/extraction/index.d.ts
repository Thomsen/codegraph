...
export declare class ExtractionOrchestrator {
    ...
    constructor(rootDir: string, queries: QueryBuilder, pathPrefix?: string);
    private indexedPath;
    private sourcePath;
    /**
     ...
     */
    indexAll(onProgress?: (progress: IndexProgress) => void, signal?: AbortSignal, verbose?: boolean, walBackpressure?: () => Promise<void> | null, storeWriterOpts?: {
        dbPath: string;
        fastInit: boolean;
    } | null): Promise<IndexResult>;
    /**
     ...
     */
    sync(onProgress?: (progress: IndexProgress) => void, 
    /**
     ...
     */
    scopedPaths?: string[]): Promise<SyncResult>;
    /**
