 ...
 */
export declare const WAL_HEAL_THRESHOLD_BYTES: number;
/** Resolve the heal threshold from the env override (MB); invalid ⇒ 64 MB. */
export declare function resolveWalHealBytes(envVal: string | undefined): number;
/**
...
export declare class DatabaseConnection {
     ...
     */
    private static readonly FTS_TRIGGER_NAMES;
    /**
